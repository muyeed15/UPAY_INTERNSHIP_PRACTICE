...
POST `/api/register/` with body `{"email":"a@a.com","password":"pass1234"}`
![Register](screenshots/01-register.png)

### 2. Login

POST `/api/login/` with body `{"email":"a@a.com","password":"pass1234"}`
...
POST `/api/token-auth/` with body `{"email":"a@a.com","password":"pass1234"}`
